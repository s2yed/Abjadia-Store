            ...
            <form class="mt-8 space-y-6" @submit.prevent="handleLogin">
                ...
                <div class="flex items-center justify-between">
                    <div class="flex items-center">
                        <input id="remember_me" v-model="form.remember" name="remember" type="checkbox" class="h-4 w-4 text-secondary-orange focus:ring-secondary-orange border-gray-300 rounded-md transition-all duration-200">
                        <label for="remember_me" class="mx-2 block text-sm text-gray-900 font-medium">
                            {{ $t('Remember me') }}
                        </label>
                    </div>

                    <div class="text-sm">
                        <a href="/password/reset" class="font-medium text-secondary-orange hover:text-orange-500 transition-colors duration-200">
                ...
                <div class="text-center mt-4">
                    <p class="text-sm text-gray-600">
                        ...
                        <a href="/register" class="font-bold text-secondary-orange hover:text-orange-500 transition-colors duration-200">
                            {{ $t('Register now') }}
                        </a>
                    </p>
                </div>
